...
#define DATA_DIR_PIN_3  13
#define DATA_DIR_PIN_4  22
#define DATA_DIR_PIN_5  23
...
uint8_t buffer_0[SERIAL_BUF_SIZE];
...
void zeroOutMagnets(){
  Serial1.write(buffer_0, SERIAL_BUF_SIZE);
  Serial1.flush(); // block until sent
        
  Serial3.write(buffer_0, SERIAL_BUF_SIZE);
  Serial3.flush(); // block until sent

  Serial2.write(buffer_0, SERIAL_BUF_SIZE);
  Serial2.flush(); // block until sent

  Serial4.write(buffer_0, SERIAL_BUF_SIZE);
  Serial4.flush(); // block until sent

  Serial5.write(buffer_0, SERIAL_BUF_SIZE);
  Serial5.flush(); // block until sent
}
